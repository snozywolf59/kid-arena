...
class ResultsScreen extends StatelessWidget {
              ...
              children: [
                ...
                CircularPercentIndicator(
                  ...
                  center: Text(
                    ...
                    style: TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 40.0, color: scoreColor),
                  ),
                ...
                _buildResultStat(
                  ...
                  label: 'Ngày nộp bài',
                  value: "${studentAnswer.submittedAt.toLocal().day}/${studentAnswer.submittedAt.toLocal().month}/${studentAnswer.submittedAt.toLocal().year}",
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: () {
                    Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(builder: (context) => const PublicTestsScreen()), // Truyền lại data
  ...
  Widget _buildResultStat(ThemeData theme,
    ...
    return Container(
      ...
      child: Row(
        children: [
          Container( // Bao Icon lại để có background
          ...
          Expanded( // Để text không bị overflow
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(label, style: theme.textTheme.bodyMedium?.copyWith(color: theme.primaryColor)),
                const SizedBox(height: 2),
                Text(value, style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w600, color: theme.primaryColor)),
              ],
            ),
          ),
        ],

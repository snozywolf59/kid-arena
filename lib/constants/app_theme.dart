...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color.fromARGB(255, 0, 136, 23),
      surfaceTint: Color.fromARGB(255, 49, 115, 49),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color.fromARGB(255, 163, 237, 167),
      onPrimaryContainer: Color(0xff354e16),
      secondary: Color.fromARGB(255, 78, 98, 73),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color.fromARGB(255, 0, 221, 114),
      surfaceTint: Color(0xffb1d18a),
      onPrimary: Color.fromARGB(255, 235, 235, 234),
      primaryContainer: Color.fromARGB(255, 7, 45, 14),
      ...
      surface: Color.fromARGB(255, 1, 50, 37),
